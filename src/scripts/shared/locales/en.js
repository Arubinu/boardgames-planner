...
export default {
  ...
  gamesPage: {
    ...
    chip_ext: 'Expansions',
    players_aria: 'Filter by number of players',
    players_all: 'Any number of players',
    players_n_one: '{count} player',
    players_n_other: '{count} players',
    players_max: '{count}+ players',
    duration_aria: 'Filter by duration',
    duration_all: 'Any duration',
    duration_short: 'Quick (≤ 30 min)',
    duration_medium: 'Medium (30–60 min)',
    duration_long: 'Long (60+ min)',
  ...
  footer: {
    ...
    github: 'This website is an open-source project that you can find here:',
  },
  ...
  notfound: {
    ...
    lead: 'The page you are looking for may have been moved, or no longer exists.',
    home: 'Back to home',
    games: 'Browse the games',
  },
  ...
  admin: {
    ...
    no_games_manual: 'No off-collection game. Add one with "+ Add a game".',
    ...
    tf_color: 'Colour',
    tf_signup: 'Registration required',
    ...
    ip_section_help:
      'Title and text shown at the top of the "Practical info" section on the home page. Links allowed in the text as [label](https://…).\nLeave empty to use the default translated text.',
    ip_field_title: 'Section title',
    ip_field_title_ph: 'Practical info',
    ip_field_sub: 'Text (links allowed)',
    ...
    bk_drop: '<strong>Click or drop a file</strong> (.json)',
    ...
    bk_cat_games: 'Games',
    bk_cat_games_myludo: 'MyLudo games',
    bk_cat_games_manual: 'Off-collection games',
    ...
    bk_images_export_help: 'Downloads a ZIP of all uploaded game images, to complement the JSON backup.',
    bk_images_export_btn: 'Export images (ZIP)',
    bk_images_import_title: 'Import images',
    bk_images_import_help: 'Imports a ZIP of images (generated above). Files are restored as-is and match the image URLs in the JSON backup, regardless of game IDs.',
    bk_images_file: 'Image archive (.zip)',
    bk_images_drop: '<strong>Click or drop an archive</strong> (.zip)',
    bk_images_import_btn: 'Import images',
    bk_images_no_file: 'Select an image archive first.',
    bk_images_imported: '{count} image(s) imported',
    ...
    gf_image: 'Cover image',
    gf_image_ph: 'https://...',
    gf_image_help:
      'Paste the address of a cover image (right click → "Copy image address" on MyLudo, for example).',
    gf_owner: 'Brought by / owner',
    gf_image_url: 'Link (URL)',
    gf_image_upload: 'Upload',
    gf_image_drop: '<strong>Click or drop an image</strong> (JPEG, PNG, WebP…)',
    gf_image_remove: 'Remove image',
    gf_name: 'Title',
    gf_subtitle: 'Subtitle',
    gf_type: 'Type',
    gf_type_base: 'Base game',
    gf_type_ext: 'Expansion',
    gf_players: 'Players',
    gf_duration: 'Duration (min)',
    gf_age: 'Age',
    gf_rating: 'Rating (0–10)',
    gf_categories: 'Categories',
    gf_themes: 'Themes',
    gf_mechanisms: 'Mechanisms',
    gf_authors: 'Authors',
    gf_publishers: 'Publishers',
    gf_details: 'External link (optional)',
    gf_csv_ph: 'comma-separated',
    gf_add_title: 'Add a game',
    gf_edit_title: 'Edit game',
    gf_myludo_title: 'Cover & owner',
    add_game: '+ Add a game',
    games_manual_title: 'Off-collection',
    games_myludo_title: 'MyLudo collection',
